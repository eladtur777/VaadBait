...
export default function PendingPaymentsScreen({ navigation }: any) {
  ...
  const handleTogglePaid = async (income: CommitteeIncome) => {
    try {
      ...
      Alert.alert(
        'עודכן',
        newIsPaid ? 'התשלום סומן כהתקבל' : 'התשלום סומן כממתין'
      );
    } catch (error) {
    ...
    <View style={styles.container}>
      ...
      >
          ...
          <Card style={styles.pendingCard}>
            <Card.Content>
              ...
              <Text style={styles.summaryCount}>
                {incomes.filter(i => !i.isPaid).length} תשלומים
              </Text>
            </Card.Content>
          </Card>
        ...
        <View style={styles.filterContainer}>
          ...
          >
            ממתין ({incomes.filter(i => !i.isPaid).length})
          </Chip>
          <Chip
          ...
          >
            התקבל ({incomes.filter(i => i.isPaid).length})
          </Chip>
        </View>
