...
export default function MonthlyReportScreen({ navigation }: any) {
  ...
  const handleExportExcel = async () => {
    try {
      ...
      const data: any[][] = [
        ['דוח חודשי - ' + monthNames[currentMonth] + ' ' + currentYear],
        [],
        ['סיכום'],
      ...
      if (Platform.OS === 'web') {
        ...
        link.href = url;
        link.download = `דוח_חודשי_${monthNames[currentMonth]}_${currentYear}.xlsx`;
        ...
        const fileUri = FileSystem.documentDirectory + 'דוח_חודשי_' + Date.now() + '.xlsx';
